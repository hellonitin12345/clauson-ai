  ...
  return (
    <div className="max-w-3xl mx-auto py-16 md:py-20 px-4 space-y-6">
      ...
      <div className="flex flex-col gap-2 items-center text-center">
        <div>
          <span className="py-4 md:py-7">
            <button className="bg-[#B1E0FC40] flex justify-center items-center px-4 py-2 border border-solid border-[#B1E0FC] ring-4 md:ring-7 ring-[#B1E0FC40] rounded-lg text-sm md:text-[16px] text-[#121215]">
              Questions
            </button>
          </span>
        </div>

        <h1 className="text-3xl md:text-4xl font-medium font-clauson">
          FAQ
        </h1>
      </div>
