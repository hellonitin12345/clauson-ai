...
const Footer = () => {
  return (
    <section className="w-full bg-white pt-15 ">
      {/* MAIN BLUE AREA */}
      <div className=" relative h-75 md:h-full md:mx-1 lg:mx-2 rounded-b-2xl bg-linear-to-r from-[#A1DAFF] to-[#B9E2FC]  overflow-hidden">
        ...
        {/* TEXT */}
         ...
         <img className="absolute bottom-0 left-25 w-60  lg:left-115 lg:w-115" 
