...
const Footer = () => {
  return (
    <section className="w-full bg-white pt-15 ">
      {/* MAIN BLUE AREA */}
      <div className=" relative h-70 md:h-full md:mx-1 lg:mx-2 rounded-b-2xl bg-linear-to-r from-[#A1DAFF] to-[#B9E2FC]  overflow-hidden">

        {/* TEXT */}
         <h1 className="text-center text-white font-clauson font-medium lg:text-9xl
         text-5xl md:text-5xl -mt-7 lg:-mt-18 lg:mb-55 lg:leading-33 lg:tracking-[-5%]">
          No paper work<br /> 
          no waiting rooms.<br />
          Just quick scan,
         </h1>

         <img className="absolute bottom-0 left-23 w-60  lg:left-115 lg:w-115" 
