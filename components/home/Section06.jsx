            ...
            >
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center">
                  ...
                  {plan.recommended && (
                    <span className="px-3 py-1 text-xs font-semibold text-[#10699E] border border-[#B1E0FC] rounded-full bg-linear-to-b from-[#B1E0FC63] to-white">
                      Recommended
                    </span>
                  )}
                </div>
              ...
              {/* BUTTON */}
              <Button1 lable="Get Started" className={` ${
                    isActive
                      ? "bg-linear-to-b from-[#B1E0FC] to-[#218BCA] text-white w-full"
                      : " border-blue-400 text-blue-600 hover:bg-blue-50 w-full"
                  } `} showIcon={false}/>
            </div>
          );
        })}
